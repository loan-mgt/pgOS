...
class InfoPopup(FloatLayout):
	...
	def show(self, source):
		...
		fermer = Button(pos_hint={'x': 0.8, 'y': 0.8}, size_hint=(0.1, 0.1),text ="FERMER",background_normal ='',color=(0,0,0,1), background_color=(1,1,1,0))
		...
		Nom = Label(text=source['name'],font_size=self.font_size, pos_hint= {'center_x': .25, 'center_y': .4},color=(0,0,0,1) )
		Num =  Label(text=source['num'],font_size=self.font_size-5, pos_hint= {'center_x': .45, 'center_y': .4},color=(0,0,0,1) )
		Genre =  Label(text=Genre_data,font_size=self.font_size-5, pos_hint= {'center_x': .65, 'center_y': .4},color=(0,0,0,1) )
		Nom_i = Label(text='Nom',font_size=self.font_size-8, pos_hint= {'center_x': .15, 'center_y': .4},color=(0,0,0,0.8) )
		Num_i =  Label(text='Num',font_size=self.font_size-5-8, pos_hint= {'center_x': .35, 'center_y': .4},color=(0,0,0,0.8) )
		Genre_i =  Label(text='Genre',font_size=self.font_size-5-8, pos_hint= {'center_x': .55, 'center_y': .4},color=(0,0,0,0.8) )
	...
	def edit(self, instance=None):
		...
		self.Nom = MDTextField(text=source['name'],font_size=self.font_size, size_hint=(0.1,0.1),pos_hint= {'center_x': .25, 'center_y': .4})
		self.Num =  MDTextField(text=source['num'],font_size=self.font_size-5,size_hint=(0.1,0.1), pos_hint= {'center_x': .45, 'center_y': .4} )
		...
		modifier = Button(pos_hint={'x': 0.7, 'y': 0.8}, size_hint=(0.1, 0.1),text ="VALIDER",background_normal ='',color=(0,0,0,1), background_color=(1,1,1,0))
		...
		self.anne = MDTextField(size_hint=(0.09,0.1),font_size=self.font_size-8, pos_hint= {'center_x': .75, 'center_y': .3} )
		...
		add  = MDIconButton(icon= "plus-thick",pos_hint= {"center_x": .85, "center_y": .3})
